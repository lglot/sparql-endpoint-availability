...
public class ParseHTMLAvailableEndpoints {
    ...
    public static void main(String[] args) throws IOException {
        InputStream input = ParseHTMLAvailableEndpoints.class
                .getResourceAsStream("/https _sparqles.ai.wu.ac.at_availability.html");
        ...
        for (Element el : endpointElements) {
            ...
            endpointURL = URLDecoder.decode(endpointURL, Charsets.UTF_8.name());
        ...
        // false).writeValue(new File("sparql_test.json"), sparqlEndpoints);
